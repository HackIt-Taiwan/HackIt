...
import { NewsItem, getLatestNews } from '@/utils/news';
...
export default function NewsDetailContent({ news, slug }: NewsDetailContentProps) {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              >
                <FaChevronLeft className="mr-2" /> 返回所有新聞
              </Link>
                ...
                <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
                  <div className="flex items-center justify-between">
                    <div className="text-gray-600 dark:text-gray-400">
                      分類: <span className="text-primary">{news.frontmatter.category}</span>
                    </div>
                    <div className="flex items-center space-x-4">
                      <span className="text-gray-600 dark:text-gray-400">分享:</span>
              ...
              <div className="mt-16">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  {relatedNews.map((relatedItem) => (
                    ...
                    >
                      <Link href={`/news/${relatedItem.slug}`} className="block">
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex items-center text-xs text-gray-500 dark:text-gray-400">
                            ...
                            <span>{new Date(relatedItem.frontmatter.date).toLocaleDateString('zh-TW', { 
                              year: 'numeric', 
                              month: 'numeric', 
                              day: 'numeric' 
                            })}</span>
