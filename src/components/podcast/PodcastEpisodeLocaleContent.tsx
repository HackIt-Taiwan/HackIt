...
interface PodcastEpisodeLocaleContentProps {
  locale: string;
  eventId: string;
  episodeId: string;
}

export default function PodcastEpisodeLocaleContent({ locale, eventId, episodeId }: PodcastEpisodeLocaleContentProps) {
  const { t } = useI18n();
