...
import { FaMicrophone, FaArrowLeft, FaCheckCircle, FaPlay, FaHeadphones } from 'react-icons/fa';
import EpisodesList from '@/components/podcast/EpisodesList';
import PodcastPlayer from '@/components/podcast/PodcastPlayer';
import { PodcastEvent, getEpisodeById, getNextEpisode, PodcastEpisode } from '@/utils/podcasts';
import { useI18n } from '@/i18n';

interface PodcastEventContentProps {
  podcast: PodcastEvent | null;
  eventId: string;
  locale: string;
}

export default function PodcastEventContent({ podcast, eventId, locale }: PodcastEventContentProps) {
  const { t } = useI18n();
  ...
  }, [podcast, router, selectedEpisodeId, locale]);
